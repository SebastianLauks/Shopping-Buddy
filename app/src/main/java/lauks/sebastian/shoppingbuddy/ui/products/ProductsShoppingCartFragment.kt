 ...
 */
class ProductsShoppingCartFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_products_shopping_cart, container, false)
    }
...
//        }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
            ProductsShoppingCartFragment().apply {
